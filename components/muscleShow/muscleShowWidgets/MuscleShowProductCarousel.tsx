...
import ProductCarouselCard from "../../HomePage/productCarouselCard/ProductCarouselCard";
import Modal from "../../Modal/modal";

const MuscleShowProductCarousel = ({
  section = null,
  myKey = null,
  isHome = true,
  customProducts = null,
...
export default MuscleShowProductCarousel;
