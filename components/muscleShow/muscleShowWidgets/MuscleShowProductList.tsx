...
import ProductListCard from "../../HomePage/productListCard/ProductListCard";
import Modal from "../../Modal/modal";

const MuscleShowProductList = ({ section, myKey, isHome = true }) => {
...
export default MuscleShowProductList;
